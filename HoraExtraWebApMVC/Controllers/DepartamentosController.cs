...
namespace HoraExtraWebApMVC.Controllers
{
    public class DepartamentosController : Controller
    {
        ...
        public DepartamentosController(HoraExtraWebApMVCContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Nome,Gestor")] Departamento departamento)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nome,Gestor")] Departamento departamento)
        {
